...
class script(object):
 ...
 𝐈 𝐀𝐦 𝐕𝐞𝐫𝐲 𝐀𝐝𝐯𝐚𝐧𝐜𝐞 & 𝐏𝐨𝐰𝐞𝐫𝐟𝐮𝐥 𝐀𝐮𝐭𝐨 𝐅𝐢𝐥𝐭𝐞𝐫 𝐁𝐨𝐭 + 📂 𝐅𝐢𝐥𝐞 𝐒𝐭𝐨𝐫𝐞 𝐁𝐨𝐭 + 🤟𝐌𝐚𝐧𝐮𝐚𝐥 𝐅𝐢𝐥𝐭𝐞𝐫 + 🔗𝐂𝐮𝐬𝐭𝐨𝐦 𝐒𝐡𝐨𝐫𝐭𝐧𝐞𝐫 𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐈𝐧 𝐆𝐫𝐨𝐮𝐩 + 🖥𝐎𝐧𝐥𝐢𝐧𝐞 𝐖𝐚𝐭𝐜𝐡 +  🚀𝐅𝐚𝐬𝐭 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝 + ♻️𝐀𝐮𝐭𝐨 𝐃𝐞𝐥𝐞𝐭𝐞 + 🌺𝐁𝐞𝐬𝐭 𝐔𝐢 𝐏𝐞𝐫𝐟𝐨𝐫𝐦𝐚𝐧𝐜𝐞 +⚡️𝐏𝐫𝐞𝐦𝐢𝐮𝐦 𝐏𝐥𝐚𝐧 𝐀𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 👉 𝐑𝐞𝐟𝐞𝐫𝐚𝐥 𝐅𝐞𝐚𝐭𝐮𝐫𝐞𝐬 👈 ( 🔗𝐍𝐨 𝐥𝐢𝐧𝐤 📂𝐃𝐢𝐫𝐞𝐜𝐭 𝐅𝐢𝐥𝐞𝐬 )</b>"""

    HELP_TXT = """<b>Hᴇʏ {}
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""

    ABOUT_TXT = """<b>⍟───[ MY ᴅᴇᴛᴀɪʟꜱ ]───⍟
 ✧ 𝐌𝐲 𝐍𝐚𝐦𝐞 : <a href=https://t.me/AutoFilterDP_bot>𝐀𝐮𝐭𝐨 𝐅𝐢𝐥𝐭𝐞𝐫 𝐃𝐏 𝐛𝐨𝐭</a>
 ✧ 𝐌𝐲 𝐁𝐞𝐬𝐭 𝐅𝐫𝐝 : <a href='tg://settings'>𝐓𝐡𝐢𝐬 𝐏𝐞𝐫𝐬𝐨𝐧</a> 
 ✧ 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 : <a href='https://t.me/mersal_dhinesh'>𝐃𝐡𝐢𝐧𝐞𝐬𝐡</a> 
 ✧ 𝐋𝐚𝐧𝐠𝐮𝐚𝐠𝐞 : <a href='https://www.python.org/download/releases/3.0/'>𝐏𝐲𝐭𝐡𝐨𝐧𝟑</a> 
 ✧ 𝐌𝐨𝐯𝐢𝐞𝐬 : <a href='https://t.me/movies_Days'>𝐓𝐚𝐦𝐢𝐥 𝐌𝐨𝐯𝐢𝐞𝐬</a>
 ✧ 𝐀𝐧𝐢𝐦𝐞𝐬 : <a href='https://t.me/AnimesWorldTamil'>𝐓𝐚𝐦𝐢𝐥 𝐀𝐧𝐢𝐦𝐞𝐬</a>"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/dp_botz)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
my features Stay here new features coming soon...  
 ...
 <b>✯ Join here : <a href=https://t.me/DP_botz>☢Join my updateds☢</a></b> 
 ...
 ./video - This command usage any YouTube video download hd [<code>example /video https://youtu.be/video</code>]

./font - This command usage stylish and cool font generator [<code>example /font HiDPbotz</code>]"""
...
★ Fʀᴇᴇ Sᴛᴏʀᴀɢᴇ: <code>{}</code></b>"""
    ...
    LOG_TEXT_G = """#NewdpfilterGroup
Gʀᴏᴜᴘ = {}(<code>{}</code>)
Tᴏᴛᴀʟ Mᴇᴍʙᴇʀs = <code>{}</code>
Aᴅᴅᴇᴅ Bʏ - {}"""

    LOG_TEXT_P = """#NewfilterdpUser
ID - <code>{}</code>
Nᴀᴍᴇ - {}"""
...
ᴇxᴀᴍᴘʟᴇ : Premalu , Aneethi

ꜱᴇʀɪᴇꜱ ʀᴇǫᴜᴇꜱᴛ ꜰᴏʀᴍᴀᴛ 👇

ᴇxᴀᴍᴘʟᴇ : one piece , Loki
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""
    ...
    MVE_NT_FND = """ᴍᴏᴠɪᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ Dp ᴅᴀᴛᴀʙᴀꜱᴇ..."""
...
DP AUTOFILTER BOT WORKING PROPERLY"""
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 படி 1: இந்த AUTOFILTER-DP-BOT போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>My Friend</a> 
 ...
 Step 1: Administer this AUTOFILTER-DP-BOT bot to your group
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: ఈ AUTOFILTER-DP-BOT బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس AUTOFILTER-DP-BOT بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>My Friend</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ AUTOFILTER-DP-BOT બોટનું સંચાલન કરો
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই AutoFilterDP_bot বট পরিচালনা করুন
...
-Dev 1 [Owner of this bot ]<a href='https://t.me/mersal_dhinesh'>OWNER</a>

-Dev 2 <a href='https://t.me/@dpowner_bot'>Dp</a>

-Dev 2 <a href='https://t.me/DP_BOTZ>Dp_BOTZ</a>

- Dev 4 <a href='https://t.me/All_Tamil_movies_request'>MOVIES GROUP</a>
"""
